package io.github.regychang.flinkify.quickstart.connector.nebula;
...
import io.github.regychang.flinkify.quickstart.connector.nebula.process.GenerateSensorMapGraph;
import io.github.regychang.flinkify.quickstart.connector.nebula.process.GenerateWorkOrderGraph;
import io.github.regychang.flinkify.quickstart.connector.nebula.serialization.PayloadDeserializationSchema;
...
public class NebulaSink extends FlinkStreaming {
    ...
    private final MapStateDescriptor<String, Map<String, List<String>>> SENSOR_MAP_DESC =
            new MapStateDescriptor<>(
                    "sensor_map-state", Types.STRING, Types.MAP(Types.STRING, Types.LIST(Types.STRING)));
    ...
    protected void execute(FlinkStreamingContext ctx) throws FlinkException {
        ...
        SingleOutputStreamOperator<Void> mapGraphStream =
                mapSourceStream.process(new GenerateSensorMapGraph(ctx.getSinkConnectors()));
