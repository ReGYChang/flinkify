...
import io.github.regychang.flinkify.flink.core.streaming.operator.process.AggProcess;
...
public class KeyedAggProcessFunc<K, IN extends UserDefinedTimeKey<IN>, OUT>
    ...
    public KeyedAggProcessFunc(
            TypeInformation<OUT> outputTypeInformation,
            OutputTag<IN> outputTag,
            AggProcess<IN, OUT> userFunction) {
                ...
                this.getRuntimeContext()
                        .getMapState(
                                new MapStateDescriptor<>(
                                        BUFFER,
                                        Types.LONG,
                                        Types.MAP(Types.STRING, outputTypeInformation)));
    }

    @Override
    public void onTimer(
            long timestamp,
            KeyedProcessFunction<K, IN, OUT>.OnTimerContext ctx,
