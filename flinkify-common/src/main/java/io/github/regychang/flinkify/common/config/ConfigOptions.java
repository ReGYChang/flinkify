    ...
    public static class ListConfigOptionBuilder<E> {
        ...
        public final ConfigOption<List<E>> defaultValues(E... values) {
            return new ConfigOption<>(
                    this.key, this.clazz, ConfigOption.EMPTY_DESCRIPTION, Arrays.asList(values), true);
        }

        public final ConfigOption<List<E>> defaultValues(List<E> list) {
            return new ConfigOption<>(
                    this.key, this.clazz, ConfigOption.EMPTY_DESCRIPTION, list, true);
        }

        public ConfigOption<List<E>> noDefaultValue() {
            return new ConfigOption<>(
                    this.key, this.clazz, ConfigOption.EMPTY_DESCRIPTION, null, true);
        }
    }
